<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Exam2.aspx.cs" Inherits="Certification.Exam2" %>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="iptSkillsn" class="col-sm-2 control-label">证书SN：<span style="color: red">*</span></label>
                        <input id="iptSkillSN" class="form-control" type="text" maxlength="50" />
                        <label for="iptSkillDescription" class="col-sm-2 control-label">证书描述：</label>
    ...
    <div id="divMain">
        ...
        <div style="padding: 4px;">
            <form runat="server" class="form-inline">
                ...
                <div class="form-group">
                    <label for="txtSkillSN">SkillSN :</label>
        ...
        <div class="row" style="padding: 10px 20px 20px 20px;" id="divList">
                    ...
                    <div class="col-sm-2 col-md-2">
                        <div class="thumbnail">
                            <div class="caption textAlignCenter">
                                <h3><%# Eval("SkillSn") %></h3>
                                <p style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap;"><%# Eval("SkillDescription") %></p>
                                <p>
                                ...
                                <p>
                                    ...
                                    <a style="background-color: #009688; color: white;" title='Exam <%# Eval("SkillSn") %>' href='javascript:;' class='btn imgExam' role='button'>考试</a>
                                    <%# userRole == 1 ? "<a title='Edit " + Eval("SkillSn") + "' href='javascript:;'  data-toggle='modal' data-target='#divAddOrUpdateSkillSN' class='btn btn-warning imgEdit' role='button'>修改</a> <a title='Delete " + Eval("SkillSn") + "' href='javascript:;' class='btn btn-danger imgDelete' role='button'>删除</a>" : "" %>
                                </p>
                            </div>
                        </div>
                    </div>
