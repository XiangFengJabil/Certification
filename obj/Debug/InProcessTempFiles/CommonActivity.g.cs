...
namespace Certification {
    ...
    public partial class CommonActivity : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(CommonActivity).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(CommonActivity));
        ...
        private string FindResource() {
            string[] resources = typeof(CommonActivity).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".CommonActivity.g.xaml") || resource.Equals("CommonActivity.g.xaml"))) {
                    return resource;
                }
            }
